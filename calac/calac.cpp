...
// calac.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CcalacApp, CWinApp)
...
// Единственный объект CcalacApp

CcalacApp theApp;


// инициализация CcalacApp

BOOL CcalacApp::InitInstance()
{
